package com.example.fisat_pro.customspinner;
...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        boolean rtl = com.example.fisat_pro.customspinner.Utils.isRtl(context);
        ...
        try {
            ...
            arrowColorDisabled = com.example.fisat_pro.customspinner.Utils.lighter(arrowColor, 0.8f);
        } finally {
            ta.recycle();
        }
        ...
        if (!hideArrow) {
            arrowDrawable = com.example.fisat_pro.customspinner.Utils.getDrawable(context, R.drawable.ms__arrow).mutate();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(com.example.fisat_pro.customspinner.Utils.getDrawable(context, R.drawable.ms__drawable));
        } else {
            popupWindow.setBackgroundDrawable(com.example.fisat_pro.customspinner.Utils.getDrawable(context, R.drawable.ms__drop_down_shadow));
        }
    ...
    @Override public void setBackgroundColor(int color) {
        ...
        if (background instanceof StateListDrawable) { // pre-L
            try {
                ...
                int[] colors = { com.example.fisat_pro.customspinner.Utils.darker(color, 0.85f), color };
    ...
    public <T> void setItems(@NonNull List<T> items) {
        adapter = new com.example.fisat_pro.customspinner.MaterialSpinnerAdapter<>(getContext(), items)
    ...
    public void setAdapter(@NonNull ListAdapter adapter) {
        this.adapter = new com.example.fisat_pro.customspinner.MaterialSpinnerAdapterWrapper(getContext(), adapter)
                .setPopupPadding(popupPaddingLeft, popupPaddingTop, popupPaddingRight, popupPaddingBottom)
                .setBackgroundSelector(backgroundSelector)
                .setTextColor(textColor);
     ...
     * @param <T> The type
     */
    public <T> void setAdapter(com.example.fisat_pro.customspinner.MaterialSpinnerAdapter<T> adapter) {
    ...
    private void setAdapterInternal(@NonNull com.example.fisat_pro.customspinner.MaterialSpinnerBaseAdapter adapter) {
